const data = [
  ...
  latitude: 29.9681,
  longitude: -90.0553,
  description: 'It’s a calm, quiet, and comfortable place for folks to come to hang out with some shelter cats and kittens, all of which are available for adoption.',
...
{id: 1,
  latitude: 29.9361,
  longitude: -90.1223,
  description: 'An interactive installation, designed by @TulaneArch professor Irene Keil and local architect David Gregor.',
...
{id: 2,
  latitude: 29.9687,
  longitude: -90.0813,
  description: 'It is clear this abandoned Art Deco gem was no ordinary cleaners.',
...
{id: 3,
  latitude: 29.9765,
  longitude: -90.0905,
  description: 'A hurricane-stricken oak tree has been reborn as a beautiful chainsaw artwork.',
...
{id: 4,
  latitude: 29.9590,
  longitude: -90.0712,
  description: 'In 2010, Nicolas Cage purchased two plots in this cemetery using one to construct this strange pyramid mausoleum.',
...
{id: 5,
  latitude: 29.9646,
  longitude: -90.0679,
  description: 'An artist weaves "wooden quilts" with scraps salvaged from his Katrina-damaged home in Tremé.',
...
{id: 6,
  latitude: 29.9653,
  longitude:  -90.0663,
  description: 'Tomb of the Unknown Slave',
...
{id: 9,
  latitude: 29.9800,
  longitude: -90.0870,
  description: 'Oldest fire hydrant in New Orleans',
  imageUrl: 'http://www.karenheath.com/firehydrant1869/fireHydrant1869bz.jpg',
  tag: 'cool'
}
]
